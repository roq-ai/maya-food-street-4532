...
export function BusinessListPage(props: BusinessListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getBusinesses({
        relations: ['user', 'business_owner.count', 'product.count', 'shop_manager.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('business_owner', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => record?._count?.business_owner,
        }
      : null,
    hasAccess('product', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('shop_manager', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'shop_manager',
          header: 'Shop Manager',
          accessorKey: 'shop_manager',
          cell: ({ row: { original: record } }: any) => record?._count?.shop_manager,
        }
      : null,
