...
import { getBusinessOwners, deleteBusinessOwnerById, createBusinessOwner } from 'apiSdk/business-owners';
import { getShopManagers, deleteShopManagerById, createShopManager } from 'apiSdk/shop-managers';
      ...
      <Box rounded="md">
        ...
        {isLoading ? (
          ...
          <>
            ...
            <Box borderRadius="10px" border="1px" borderColor={'base.300'} mt={6}>
              <UserPageTable
                createHandler={createBusinessOwner}
                deleteHandler={deleteBusinessOwnerById}
            ...
            <Box borderRadius="10px" border="1px" borderColor={'base.300'} mt={6}>
              <UserPageTable
                createHandler={createShopManager}
                deleteHandler={deleteShopManagerById}
                fetcher={getShopManagers}
                entity="shop_manager"
                title="Shop Managers"
                filters={{ business_id: id }}
                hidePagination={true}
