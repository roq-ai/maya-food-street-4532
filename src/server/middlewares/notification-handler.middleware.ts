...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'product.update': {
    roles: ['business-owner', 'shop-manager'],
    key: 'product-update',
    tenantPath: ['business', 'product'],
    userPath: [],
  },
  'product.delete': {
    roles: ['business-owner', 'shop-manager'],
    key: 'product-deletion',
    tenantPath: ['business', 'product'],
    userPath: [],
  },
  'shop_manager.delete': {
    roles: ['business-owner'],
    key: 'shop-manager-removal',
    tenantPath: ['business', 'shop_manager'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['business-owner', 'shop-manager'];
